...
<!----------------------------------------------------------------------------------------------------------------------------------------->
    ...
    <div class="box">
                <div class="strongPointImage">
                    <img src="<?php get_stylesheet_directory_uri();?>/poriporiporiImage/programming-1873854_1920.png">
                </div>
                <div class="desc">
            ...
            <div class="box">
                <div class="strongPointImage">
                    <img src="<?php get_template_directory_uri();?>/poriporiporiImage/workspace-1280538_1920.jpg">
                </div>
            <div class="desc">
                <section class="strongPointSentence">
                    <h2>素早い返信による快適な連絡</h2>
