...
<!----------------------------------------------------------------------------------------------------------------------------------------->
    ...
    <div class="box">
                <div class="strongPointImage">
                    <img src="<?php get_template_directory_uri();?>wp-content/uploads/poriporiporiImage/programming-1873854_1920.png">
                </div>
                <div class="desc">
                    <section class="strongPointSentence fadeInLeft">
                        <h2>お客様にあった<br>
                            ホームページをデザイン</h2>
                        <h5>
            ...
            <div class="box">
                <div class="strongPointImage">
                    <img src="<?php get_template_directory_uri();?>wp-content/uploads/poriporiporiImage/workspace-1280538_1920.jpg">
                </div>
            <div class="desc">
...
<!--------------------------------------------------------------------------------------------------------------------------------------->
        ...
        <div class="snsSpace">
            <form method="post" action="https://twitter.com/pori072">
                <button ><i class="fab fa-twitter fa-3x my-skyblue faa-wrench  animated-hover"></i></button>
            </form>
            <form method="post" action="https://github.com/pori777">
